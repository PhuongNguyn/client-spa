            ...
            <div className="footer-information-inner flex-1 text-center flex justify-center">
              <div>
                ...
                <div className="footer-information-social flex gap-2 justify-center mt-3">
                  <Link href={'https://www.instagram.com/delisbeautyspa/'} target="_blank"><AiFillInstagram className="icon-social-footer" size={27} /></Link>
                  <Link href={'https://www.facebook.com/delisspanhatrang/'} target="_blank"><FaFacebookSquare className="icon-social-footer" size={25} /></Link>
